...
@Component({
  selector: 'app-report-build2edit',
  templateUrl: './report-build2edit.component.html',
  styleUrls: ['./report-build2edit.component.scss']
})
    ...
    this.reportBuilderService.getrbDetailsById(id).subscribe(
      (data) => {
        ...
        if(this.builderLine[0].model != '')
        {
          ...
          this.nodeEditProperties.adhoc_param_html = this.builderLineData[0].adhoc_param_html;
